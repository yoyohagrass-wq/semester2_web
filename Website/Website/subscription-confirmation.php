...
<head>
  ...
  <title>Subscription Confirmed - Al Mesbah Al Modie Foundation</title>
        ...
        <div class="col-md-8 col-lg-6">
          <div class="card shadow-lg border-0 rounded-4 text-center">
            <div class="card-body p-5">
              ...
              <h6 class="text-muted mb-3 text-uppercase fw-semibold">Subscription confirmed</h6>
              <h2 class="mb-2 fw-bold">Al Mesbah Al Modie Foundation</h2>
              <p class="text-muted mb-4">Charity and humanitarian aid in Egypt</p>
              <h1 class="display-5 fw-bold mb-4">Subscription Successful</h1>
              <p class="lead mb-3">Thank you for subscribing to our newsletter.</p>
              <p class="text-muted mb-5">You will now receive updates about Al Mesbah Al Modie Foundation programs, campaigns, and humanitarian aid work across Egypt.</p>
