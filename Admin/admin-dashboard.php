    ...
    <div class="container-fluid">
        <div class="row min-vh-100">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar py-4">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item"><a class="nav-link active text-white" href="admin-dashboard.php"><i class="fas fa-home me-2"></i>Dashboard</a></li>
            ...
            <main class="col-md-9 col-lg-10 px-4 py-4">
                <h2 class="mb-4">Welcome, <?php echo htmlspecialchars($_SESSION['admin_username'] ?? 'Admin'); ?></h2>

                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                <h5 class="card-title"><i class="fas fa-donate text-success me-2"></i>Recent Donations</h5>
                                <ul class="list-unstyled">
                                    <li><strong>Ahmed Hassan:</strong> 500 EGP</li>
                                    <li><strong>Fatma Ali:</strong> 200 EGP</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                <h5 class="card-title"><i class="fas fa-calendar text-warning me-2"></i>Upcoming Events</h5>
                                <ul class="list-unstyled">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                <h5 class="card-title"><i class="fas fa-envelope text-info me-2"></i>New Messages</h5>
                                <p class="mb-0">You have <strong>5</strong> new messages.</p>
                                <a href="messages.php" class="btn btn-sm btn-info mt-3">View Messages</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                <h5 class="card-title"><i class="fas fa-tasks text-primary me-2"></i>Admin Tasks</h5>
                                <div class="btn-group-vertical w-100" role="group">
                                    <a href="manage-users.php" class="btn btn-outline-primary text-start">Manage Users</a>
                                    <a href="manage-services.php" class="btn btn-outline-primary text-start">Manage Services</a>
                                </div>
                            </div>
                        </div>
                    </div>
